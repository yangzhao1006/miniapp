...
Page({
  ...
  onReady(e) {
    ...
    this.innerAudioContext2.onPlay(() => {
      console.log(
        i18next.t(
          "ant-mini-program-demo.API.create-inner-audiocontext.create-inner-audiocontext.StartPlayback",
          "开始播放2"
        )
      );
    });
    this.innerAudioContext2.onPause(() => {
      console.log(
        i18next.t(
          "ant-mini-program-demo.API.create-inner-audiocontext.create-inner-audiocontext.StopPlayback.1",
          "停止播放2"
        )
      );
    });
  ...
  getAllProps() {
    ...
    my.alert({
      content:
        i18next.t(
          "ant-mini-program-demo.API.create-inner-audiocontext.create-inner-audiocontext.AudioProperties",
          "音频属性："
        ) + result,
    });
    console.log(result);
