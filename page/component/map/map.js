...
const customCalloutMarker = [
  {
    ...
    customCallout: {
      ...
      descList: [
        {
          desc: i18next.t(
            "ant-mini-program-demo.component.map.map.Estimated",
            "预计"
          ),
          descColor: "#333333",
        },
        {
          desc: i18next.t(
            "ant-mini-program-demo.component.map.map.Minutes",
            "5分钟"
          ),
          descColor: "#108EE9",
        },
        {
          desc: i18next.t(
            "ant-mini-program-demo.component.map.map.Arrival",
            "到达"
          ),
          descColor: "#333333",
        },
...
Page({
  ...
  demoMarkerAnimation() {
    if (!my.canIUse("createMapContext.return.updateComponents")) {
      my.alert({
        title: i18next.t(
          "ant-mini-program-demo.component.map.map.TheClientVersionIsToo",
          "客户端版本过低"
        ),
        content: i18next.t(
          "ant-mini-program-demo.component.map.map.ThisMapctxUpdatecomponentsMustBe",
          "this.mapCtx.updateComponents 需要 10.1.35 及以上版本"
        ),
      });
